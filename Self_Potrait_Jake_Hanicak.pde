...
boolean blowUp = true; // boolean for triggering an action in my animation
int bubbleWidth = 40; // width of the bubble (for animation)
int bubbleHeight = 20; // height of the bubble (for animation)
